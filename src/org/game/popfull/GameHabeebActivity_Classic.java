...
public class GameHabeebActivity_Classic extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener, IOnAreaTouchListener, IOnMenuItemClickListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private ITextureRegion mXPlaceHolderTextureRegion;
	...
	private int NumOfFacesUnderScreen=0;
	...
	public void onCreateResources() {
		...
		this.mBitmapTextureAtlas = new BitmapTextureAtlas(this.getTextureManager(), 1000, 1000, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		...
		this.mScorebackground=BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "ScoreBack.png", 400, 0);//600=x 100=y
		this.mGameOverFadeTextureRegion=BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "gameover_fade.png", 600, 0);
		this.mBackground=BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "back_Classic.png", 0, 100);
		this.mXTextureRegion=BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "x.png", 0, 700);
		this.mXPlaceHolderTextureRegion=BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.mBitmapTextureAtlas, this, "x_placeholder.png", 0, 780);
	...
	public boolean onKeyDown(final int pKeyCode, final KeyEvent pEvent) {
		...
		if(pKeyCode == KeyEvent.KEYCODE_BACK && pEvent.getAction() == KeyEvent.ACTION_DOWN) {
			Intent intent = new Intent(GameHabeebActivity_Classic.this, MainMenu.class);
	...
	public void secondarygameoversequence()
	{
	    ...
	    new ITimerCallback() {
	        ...
	        public void onTimePassed(TimerHandler pTimerHandler) {
	        	...
	        	for(int x=0;x<faces.size();x++)
	        	{
	        		...
	        		if(tempface.getY()>CAMERA_HEIGHT&&tempface.getX()>0&&tempface.getX()<CAMERA_WIDTH&&tempface.getTextureRegion()!=mSkullBallTextureRegion)
	        		{
	        			faces.remove(x);
	        			NumOfFacesUnderScreen++;
	        			createEx(NumOfFacesUnderScreen);
	        		}
	        	}
	        	if(NumOfFacesUnderScreen>3&&isGameOver==false)
	        	{
	        		isGameOver=true;
	        		secondarygameoversequence();
	        	}
	        }
	    });
	...
	private void createEx(int currentxs)
	{
		Sprite ex = new Sprite(0, 0, mXTextureRegion, this.getVertexBufferObjectManager());
		ex.setScale((CAMERA_WIDTH/5)/ex.getWidth());
		ex.setX(NumOfFacesUnderScreen*ex.getWidth()-ex.getWidth());
		mScene.attachChild(ex);

	}
	
	private void createExPlaceHolder(int numberofplaceholders)
	{
		for(int x=1;x<=numberofplaceholders;x++)
		{
			Sprite explchldr = new Sprite(0, 0, mXPlaceHolderTextureRegion, this.getVertexBufferObjectManager());
			explchldr.setScale((CAMERA_WIDTH/5)/explchldr.getWidth());
			explchldr.setX(x*explchldr.getWidth()-explchldr.getWidth());
			mScene.attachChild(explchldr);
		}
	...
	{
		Intent intent = new Intent(GameHabeebActivity_Classic.this, GameOverScreen.class);
		Bundle b = new Bundle();
