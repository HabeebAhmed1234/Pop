...
public class UniformColorSprite extends Sprite {
	...
	protected void preDraw(final GLState pGLState, final Camera pCamera) {
		...
		GLES20.glUniform4f(PositionTextureCoordinatesUniformColorShaderProgram.sUniformColorLocation, this.mAndengineColor.getRed(), this.mAndengineColor.getGreen(), this.mAndengineColor.getBlue(), this.mAndengineColor.getAlpha());
	}
