...
public class CircleParticleEmitter extends BaseCircleParticleEmitter {
	...
	public void getPositionOffset(final float[] pOffset) {
		...
		pOffset[VERTEX_INDEX_X] = this.mCenterX + Math.cos(random) * this.mRadiusX * MathUtils.RANDOM.nextFloat();
		pOffset[VERTEX_INDEX_Y] = this.mCenterY + Math.sin(random) * this.mRadiusY * MathUtils.RANDOM.nextFloat();
	}
