...
import com.stupidfungames.pop.turret.TurretStateMachine.State;
import java.util.ArrayList;
import org.andengine.entity.sprite.Sprite;
import org.andengine.util.color.AndengineColor;

import static com.stupidfungames.pop.turret.TurretsConstants.TURRET_DRAGGING_SCALE_MULTIPLIER;
...
public class TurretEntity extends BaseEntity implements HostTurretCallback, BaseStateMachine.Listener<TurretStateMachine.State> {
    ...
    protected void createBindings(Binder binder) {
        ...
        binder.bind(TurretCannonRotationManagerEntity.class, new TurretCannonRotationManagerEntity(this));
    }
