...
public class FixedStepPhysicsWorld extends PhysicsWorld {
	...
	public FixedStepPhysicsWorld(final int pStepsPerSecond, final Vec2 pGravity, final boolean pAllowSleep) {
		this(pStepsPerSecond, Integer.MAX_VALUE, pGravity, pAllowSleep);
	}

	public FixedStepPhysicsWorld(final int pStepsPerSecond, final int pMaximumStepsPerUpdate, final Vec2 pGravity, final boolean pAllowSleep) {
		super(pGravity, pAllowSleep);
		this.mTimeStep = 1.0f / pStepsPerSecond;
		this.mMaximumStepsPerUpdate = pMaximumStepsPerUpdate;
	}

	public FixedStepPhysicsWorld(final int pStepsPerSecond, final Vec2 pGravity, final boolean pAllowSleep, final int pVelocityIterations, final int pPositionIterations) {
		this(pStepsPerSecond, Integer.MAX_VALUE, pGravity, pAllowSleep, pVelocityIterations, pPositionIterations);
	}

	public FixedStepPhysicsWorld(final int pStepsPerSecond, final int pMaximumStepsPerUpdate, final Vec2 pGravity, final boolean pAllowSleep, final int pVelocityIterations, final int pPositionIterations) {
