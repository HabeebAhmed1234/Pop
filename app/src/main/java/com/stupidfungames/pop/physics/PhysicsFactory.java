...
public class PhysicsFactory {
  ...
  public static FixtureDef createFixtureDef(final float pDensity, final float pElasticity,
      final float pFriction) {
  ...
  public static Body createLineBody(final PhysicsWorld physicsWorld, final Line line,
      final BodyType pBodyType, final FixtureDef pFixtureDef) {
    float[] center = GeometryUtils
        .getCenterPoint(line.getX1(), line.getY1(), line.getX2(), line.getY2());
  ...
  public static Body createBoxBody(final PhysicsWorld pPhysicsWorld, final float pCenterX,
      final float pCenterY, final float pWidth, final float pHeight, final BodyType pBodyType,
      final FixtureDef pFixtureDef) {
    return PhysicsFactory
        .createBoxBody(pPhysicsWorld, pCenterX, pCenterY, pWidth, pHeight, 0, pBodyType,
  ...
  public static Body createBoxBody(final PhysicsWorld pPhysicsWorld, final float pCenterX,
      ...
      final BodyType pBodyType, final FixtureDef pFixtureDef) {
    return PhysicsFactory
        .createBoxBody(pPhysicsWorld, pCenterX, pCenterY, pWidth, pHeight, pRotation, pBodyType,
            pFixtureDef, PIXEL_TO_METER_RATIO_DEFAULT);
  }
  ...
  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final IAreaShape pAreaShape,
      final float radiusScaleFactor, final BodyType pBodyType, final FixtureDef pFixtureDef) {
    return PhysicsFactory
        .createCircleBody(pPhysicsWorld, pAreaShape, radiusScaleFactor, pBodyType, pFixtureDef,
            PIXEL_TO_METER_RATIO_DEFAULT);
  }
  ...
  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final IAreaShape pAreaShape,
      final BodyType pBodyType, final FixtureDef pFixtureDef) {
    return PhysicsFactory.createCircleBody(pPhysicsWorld, pAreaShape, pBodyType, pFixtureDef,
        PIXEL_TO_METER_RATIO_DEFAULT);
  }

  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final IAreaShape pAreaShape,
      final BodyType pBodyType, final FixtureDef pFixtureDef, final float pPixelToMeterRatio) {
    return createCircleBody(pPhysicsWorld, pAreaShape, 1, pBodyType, pFixtureDef,
        pPixelToMeterRatio);
  }
  ...
  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final IAreaShape pAreaShape,
    ...
    final float centerX = sceneCenterCoordinates[Constants.VERTEX_INDEX_X];
    final float centerY = sceneCenterCoordinates[Constants.VERTEX_INDEX_Y];
    return PhysicsFactory.createCircleBody(pPhysicsWorld, centerX, centerY,
        pAreaShape.getWidthScaled() * 0.5f * radiusScaleFactor, pAreaShape.getRotation(), pBodyType,
        pFixtureDef, pPixelToMeterRatio);
  }

  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final float pCenterX,
      final float pCenterY, final float pRadius, final BodyType pBodyType,
      final FixtureDef pFixtureDef) {
  ...
  public static Body createCircleBody(final PhysicsWorld pPhysicsWorld, final float pCenterX,
      final float pCenterY, final float pRadius, final float pRotation, final BodyType pBodyType,
      final FixtureDef pFixtureDef) {
    return createCircleBody(pPhysicsWorld, pCenterX, pCenterY, pRadius, pRotation, pBodyType,
        pFixtureDef, PIXEL_TO_METER_RATIO_DEFAULT);
  }
  ...
  /**
   * @param pVertices are to be defined relative to the center of the pShape and have the {@link
   * PhysicsConstants#PIXEL_TO_METER_RATIO_DEFAULT} applied.
   */
  public static Body createPolygonBody(final PhysicsWorld pPhysicsWorld, final IShape pShape,
      final Vec2[] pVertices, final BodyType pBodyType, final FixtureDef pFixtureDef) {
    return PhysicsFactory
        .createPolygonBody(pPhysicsWorld, pShape, pVertices, pBodyType, pFixtureDef,
            PIXEL_TO_METER_RATIO_DEFAULT);
  }
  ...
  /**
   * @param pTriangleVertices are to be defined relative to the center of the pShape and have the
   * {@link PhysicsConstants#PIXEL_TO_METER_RATIO_DEFAULT} applied.
   */
  public static Body createTrianglulatedBody(final PhysicsWorld pPhysicsWorld, final IShape pShape,
      final List<Vec2> pTriangleVertices, final BodyType pBodyType, final FixtureDef pFixtureDef) {
    return PhysicsFactory
        .createTrianglulatedBody(pPhysicsWorld, pShape, pTriangleVertices, pBodyType, pFixtureDef,
            PIXEL_TO_METER_RATIO_DEFAULT);
  }

  /**
   * @param pTriangleVertices are to be defined relative to the center of the pShape and have the
   * {@link PhysicsConstants#PIXEL_TO_METER_RATIO_DEFAULT} applied. The vertices will be
   * triangulated and for each triangle a {@link Fixture} will be created.
   */
  public static Body createTrianglulatedBody(final PhysicsWorld pPhysicsWorld, final IShape pShape,
      final List<Vec2> pTriangleVertices, final BodyType pBodyType, final FixtureDef pFixtureDef,
      final float pPixelToMeterRatio) {
