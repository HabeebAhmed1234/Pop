...
import com.stupidfungames.pop.physics.util.iterators.BodyIterator;
import com.stupidfungames.pop.physics.util.iterators.ContactIterator;
import com.stupidfungames.pop.physics.util.iterators.JointIterator;
...
public class PhysicsWorld implements IUpdateHandler {
  ...
  public PhysicsWorld(final Vec2 pGravity, final boolean pAllowSleep, final int pVelocityIterations,
  ...
  public void registerPhysicsConnector(final IPhysicsConnector pPhysicsConnector) {
    this.mPhysicsConnectorManager.add(pPhysicsConnector);
  }

  public void unregisterPhysicsConnector(final IPhysicsConnector pPhysicsConnector) {
  ...
  public void QueryAABB(final QueryCallback pCallback, final float pLowerX, final float pLowerY,
      final float pUpperX, final float pUpperY) {
    this.mWorld
        .queryAABB(pCallback, new AABB(new Vec2(pLowerX, pLowerY), new Vec2(pUpperX, pUpperY)));
  }
  ...
  public void rayCast(final RayCastCallback pRayCastCallback, final Vec2 pPoint1,
      final Vec2 pPoint2) {
