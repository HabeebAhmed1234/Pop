...
public abstract class TrayIconsHolderBaseEntity<IconIdType> extends BaseEntity {
  ...
  public void refreshTrayPositionOnAnchor() {
    ...
    if (iconsTray != null) {
      ...
      if (currentState == TrayStateMachine.State.CLOSED
          || currentState == TrayStateMachine.State.EMPTY) {
  ...
  public int getTrayWidthPx() {
    ...
    throw new IllegalArgumentException(
        "No width for layout orientation " + getSpecInternal().layoutOrientation);
  }
  ...
  public int getTrayHeightPx() {
    ...
    throw new IllegalArgumentException(
        "No height for layout orientation " + getSpecInternal().layoutOrientation);
  }
