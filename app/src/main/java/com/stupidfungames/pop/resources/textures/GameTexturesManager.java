...
public class GameTexturesManager extends BaseEntity {
  ...
  private void initImageResources() {
    IMAGE_RESOURCES = Arrays.asList(
        ...
        new ImageResource(TextureId.WALL_V2, "wallv2.png", 720, 141),
        new ImageResource(TextureId.WALL_V2_FILL, "wallv2_fill.png", 720, 141),
        new ImageResource(TextureId.POINTER, "pointer.png", 300, 300)
    );
  }
