...
public class ScoreTickerSpritePool extends ItemPool {
  ...
  private final ItemInitializer initializer = new ItemInitializer<Text, SpriteInitializerParams>() {

    @Override
    public Text createNew(SpriteInitializerParams params) {
    ...
    @Override
    public void update(Text item, SpriteInitializerParams params) {
      item.setX(params.x);
      item.setY(params.y);
    }
