...
public class DoubleTapGesture extends BaseEntity implements IOnAreaTouchListener {
    ...
    @Override
    public boolean onAreaTouched(TouchEvent touchEvent, ITouchArea touchArea, float pTouchAreaLocalX, float pTouchAreaLocalY) {
