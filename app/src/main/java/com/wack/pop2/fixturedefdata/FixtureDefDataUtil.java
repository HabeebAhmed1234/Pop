...
public class FixtureDefDataUtil {
    ...
    public static boolean isBubbleFixtureDefData(Fixture fixture) {
        return fixture.m_userData != null && fixture.m_userData instanceof BubbleFixtureDefData;
    }


    public static boolean isFloorFixtureDefData(Fixture fixture) {
        return fixture.m_userData != null && fixture.m_userData instanceof FloorFixtureDefData;
    }
}
