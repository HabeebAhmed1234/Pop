...
public class GameFixtureDefs {
    ...
    public static final FixtureDef TURRET_BODY_FIXTURE_DEF = PhysicsFactory.createFixtureDef(1f, 1f, 1f);
    public static final FixtureDef TURRET_CANNON_FIXTURE_DEF = PhysicsFactory.createFixtureDef(1f, 1f, 1f);
}
